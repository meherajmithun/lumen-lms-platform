...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course owned by one instructor, containing ordered lessons and quizzes.';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Links a student to a course. The (student, course) pair is unique.';
...
export interface ApiLearningSessionLearningSession
  ...
  info: {
    description: 'Server-timed active learning for one student, lesson, browser visit and UTC date.';
    displayName: 'Learning Session';
    pluralName: 'learning-sessions';
    singularName: 'learning-session';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    activeSeconds: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lastHeartbeatAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::learning-session.learning-session'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLessonProgressLessonProgress
  ...
  info: {
    description: 'One row per completed lesson per student. `course` is denormalised so course progress is two counts, not a join walk.';
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Blog post. Uses Strapi's native Draft & Publish \u2014 only published entries are ever exposed publicly.";
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One MCQ question. `correctOptionId` is the answer key and must never be sent to a student.';
  ...
  attributes: {
    correctOptionId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A graded submission. Every score field is computed server-side and never accepted from the request body.';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An MCQ quiz attached to a course.';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
...
export interface ApiStudentStoryStudentStory
  extends Struct.CollectionTypeSchema {
  collectionName: 'student_stories';
  info: {
    displayName: 'Student Story';
    pluralName: 'student-stories';
    singularName: 'student-story';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    instructorApprovalPending: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::student-story.student-story': ApiStudentStoryStudentStory;
