export default { routes: [
  ...
  {method:'GET',path:'/enrollment-applications/mine',handler:'enrollment-application.mine',config:{policies:['global::is-authenticated',{name:'global::has-role',config:{roles:['student']}}]}},
